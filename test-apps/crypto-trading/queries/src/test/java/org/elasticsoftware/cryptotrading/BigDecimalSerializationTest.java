...
public class BigDecimalSerializationTest {
    ...
    void testBigDecimalSerializationAsString() throws Exception {
        WalletQueryModelState.Balance balance = new WalletQueryModelState.Balance(
            "EUR",
            new BigDecimal("1000.50"),
            new BigDecimal("100.25")
        );
        
        WalletQueryModelState wallet = new WalletQueryModelState(
            "wallet-123",
            List.of(balance)
        );
        ...
        assertThat(json).contains("\"1000.50\"");
        assertThat(json).contains("\"100.25\"");
        // Ensure they are NOT serialized as numbers (no decimal point without quotes)
        assertThat(json).doesNotContain(":1000.50");
        assertThat(json).doesNotContain(":100.25");
    }
    ...
    void testBigDecimalWithScientificNotation() throws Exception {
        ...
        assertThat(json).contains("\"0.00000000\"");
