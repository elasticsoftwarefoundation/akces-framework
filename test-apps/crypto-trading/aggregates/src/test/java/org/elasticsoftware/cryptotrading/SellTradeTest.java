...
@ContextConfiguration(initializers = SellTradeTest.Initializer.class)
@Testcontainers
@DirtiesContext
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class SellTradeTest {
    ...
    @Test
    @Order(2)
    void testCreateBTCEURMarketAndMakeASellTrade() {
        while (!walletController.isRunning() ||
                !accountController.isRunning() ||
                !orderProcessManagerController.isRunning() ||
                !cryptoMarketController.isRunning() ||
        ...
        try (
            ...
            // check that all events are received (in no particular order)
