 ...
 */
public class KafkaTopicSchemaStorage implements SchemaStorage {
    
    private static final Logger logger = LoggerFactory.getLogger(KafkaTopicSchemaStorage.class);
    ...
    public KafkaTopicSchemaStorage(Consumer<String, SchemaRecord> consumer) {
     ...
     */
    public KafkaTopicSchemaStorage(
    ...
    @Override
    public void saveSchema(String schemaName, JsonSchema schema, int version) throws SchemaException {
