 ...
 */
public interface SchemaStorage extends Closeable {
     ...
     */
    void saveSchema(String schemaName, JsonSchema schema, int version);
     ...
     */
    List<SchemaRecord> getSchemas(String schemaName);
     ...
     */
    Optional<SchemaRecord> getSchema(String schemaName, int version);
