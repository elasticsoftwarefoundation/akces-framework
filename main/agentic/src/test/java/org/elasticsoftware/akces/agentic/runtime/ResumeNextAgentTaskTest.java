...
class ResumeNextAgentTaskTest {
    ...
    void setUp() {
        ...
        runtime = new KafkaAgenticAggregateRuntime(delegate, objectMapper, TaskState.class, agentPlatform, aggregate, 100);
    }
    ...
    void resumeShouldDoNothingWhenStateDoesNotImplementTaskAwareState() throws IOException {
        var simpleRuntime = new KafkaAgenticAggregateRuntime(delegate, objectMapper, SimpleState.class, agentPlatform, aggregate, 100);
